...
SRC = ROOT / "example" / "claude_example.json"
EXP_CHATS = 2
EXP_MSGS = 4
STATS = "2 chats &middot; 4 messages"
DOM_NEEDLES = ["Example Title", "Placeholder text", "Placeholder query", "Placeholder advice"]
INDEX_NEEDLES = [
    '"t": "placeholder text"',
    '"t": "placeholder advice"',
    '"fmt": "claude"',
]
STDOUT_NEEDLES = ["[claude]", "2 chat(s), 4 msg(s)"]


class TestClaudeE2E(unittest.TestCase):
    def test_generate_archive(self):
        tmp = tempfile.mkdtemp(prefix="aia_e2e_claude_")
