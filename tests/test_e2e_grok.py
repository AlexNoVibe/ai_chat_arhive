...
SRC = ROOT / "example" / "grok_example.json"
EXP_CHATS = 1
EXP_MSGS = 2
STATS = "1 chats &middot; 2 messages"
DOM_NEEDLES = [
    "Placeholder Conversation Topic",
    "Example query about the topic: what is the main subject?",
    "Placeholder detailed response text based on the input prompt.",
]
INDEX_NEEDLES = [
    '"t": "example query about the topic: what is the main subject?"',
    '"t": "placeholder detailed response text based on the input prompt."',
    '"src": "grok_example.json"',
    '"fmt": "grok"',
]
STDOUT_NEEDLES = ["[grok]", "1 chat(s), 2 msg(s)"]


class TestGrokE2E(unittest.TestCase):
    def test_generate_archive(self):
        tmp = tempfile.mkdtemp(prefix="aia_e2e_grok_")
